 ...
 * HeatWaveAction or ColdWaveAction) to do whatever its
 * job is, like increase or decrease the temperature.
 */
public class ColdSnapAction implements ActionListener {

    private TemperatureSensor temperatureSensor;

    public ColdSnapAction(TemperatureSensor temperatureSensor) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        temperatureSensor.adjustTemperature(-27);
    }
}
